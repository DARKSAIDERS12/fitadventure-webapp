...
🚀 **Готовы к трансформации?** Свяжитесь прямо сейчас!"""
    ...
    # Обработка кнопок мини-приложений
        ...
        # Показываем меню базы продуктов прямо в чате
        keyboard = [
...
• 🌾 **Сложные углеводы** - овсянка, гречка, киноа, булгур
• ⚡ **Простые углеводы** - мед, фрукты, сухофрукты
• 🥩 **Белки** - куриная грудка, рыба, творог, протеин
• 🫒 **Ненасыщенные жиры** - орехи, авокадо, оливковое масло
• 🧈 **Насыщенные жиры** - сливочное масло, сыр
• 🌿 **Клетчатка** - овощи, бобовые

🔍 **Дополнительные функции:**
• **Поиск продукта** - найдите продукт по названию
